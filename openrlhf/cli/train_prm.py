...
if __name__ == "__main__":
    ...
    # Checkpoint
    parser.add_argument("--save_path", type=str, default="/home/tsj/OpenRLHF/checkpoint")
    ...
    # PRM training
    parser.add_argument("--pretrain", type=str, default="/home/tsj/OpenRLHF/hf_models/Qwen2.5-Math-PRM-7B")
    ...
    # custom dataset
    parser.add_argument("--dataset", type=str, default="/home/tsj/OpenRLHF/evaluation/outputs/Qwen2.5-Math-1.5B-sft-132k-dpo-40k/NuminaMath-CoT-Small-215k/NuminaMath-CoT-Small-00000_qwen25-math-cot_-1_seed0_t0.7_s0_e-1_prm_hacking.jsonl")
    parser.add_argument("--dataset_probs", type=str, default="1.0", help="sampling probs for datasets")
    parser.add_argument("--train_split", type=str, default="train", help="train split of the HF dataset")
    parser.add_argument("--eval_split", type=str, default="test", help="test split of the dataset")

    parser.add_argument("--input_key", type=str, default="response", help="JSON dataset key")
