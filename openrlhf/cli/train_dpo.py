...
if __name__ == "__main__":
    ...
    # Checkpoints
    parser.add_argument("--save_path", type=str, default="/home/tsj/OpenRLHF/checkpoint/Qwen2.5-Math-7B-VR-epo1")
    ...
    # Custom dataset
    parser.add_argument("--pretrain", type=str, default="/home/tsj/OpenRLHF/hf_models/Qwen2.5-Math-7B")
    parser.add_argument("--ref_pretrain", type=str, default=None)
    parser.add_argument("--dataset", type=str, default="/home/tsj/OpenRLHF/evaluation/outputs/Qwen2.5-Math-7B/math8k/debug_qwen25-math-cot_-1_seed0_t0.7_s0_e-1_VRs_dpo.jsonl")
